...
# Generation Normally Distributed Data
#
...
#
# SciPy for Checking Empirical Rule
#
# def gaussian(x, mu, sigma):
#     factor1 = 1.0 / (sigma * ((2 * pylab.pi) ** 0.5))
#     factor2 = pylab.e ** -(((x - mu) ** 2) / (2 * sigma**2))
...
#                 gaussian, mu - numStd * sigma, mu + numStd * sigma, (mu, sigma)
#             )[0]
...
#     means.append(findPocketReturn(game, 1, num_spins, False)[0])
